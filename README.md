...
```
./build_standalone.sh -t govway_standalone:3.3.0
docker run -v ~/govway_home:/var/govway -p 8080:8080 -p 8443:8443 govway_standalone:3.3.0
```

In modalità compose

```
./build_compose.sh -t govway_compose:3.3.0
cd target 
docker-compose up
```
...
```
docker run govway_compose:3.3.0 true
