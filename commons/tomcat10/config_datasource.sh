...
sqlserver)
    ...
    JDBC_RUN_URL='jdbc:sqlserver://${GOVWAY_DB_SERVER};databaseName=${GOVWAY_DB_NAME}${DATASOURCE_CONN_PARAM}'

    JDBC_CONF_URL='jdbc:sqlserver://${GOVWAY_CONF_DB_SERVER};databaseName=${GOVWAY_CONF_DB_NAME}${DATASOURCE_CONF_CONN_PARAM}'

    JDBC_TRAC_URL='jdbc:sqlserver://${GOVWAY_TRAC_DB_SERVER};databaseName=${GOVWAY_TRAC_DB_NAME}${DATASOURCE_TRAC_CONN_PARAM}'

    JDBC_STAT_URL='jdbc:sqlserver://${GOVWAY_STAT_DB_SERVER};databaseName=${GOVWAY_STAT_DB_NAME}${DATASOURCE_STAT_CONN_PARAM}'
