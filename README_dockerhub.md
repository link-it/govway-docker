...
* [`3.3.16.b1`, `3.3.16.b1_standalone`, `latest` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_postgres` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_run_postgres` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_manager_postgres` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_batch_postgres` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_oracle` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_run_oracle` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_manager_oracle` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
* [`3.3.16.b1_batch_oracle` (Dockerfile)](https://github.com/link-it/govway-docker/blob/gw_3.3.16.b1/govway/tomcat9/Dockerfile.govway)
...
```shell
CONTAINER_ID=$(docker run -d -e GOVWAY_DEFAULT_ENTITY_NAME=Ente linkitaly/govway:3.3.16.b1_postgres initsql)
...
version: '2'
 services:
  ...
  batch_stat_orarie:
    ...
    image: linkitaly/govway:3.3.16.b1_batch_postgres
    command: 
      - orarie
    environment:
